...
const fetchNeighborhoods = () => {
    DBHelper.readAllRestaurants().then((restaurants) => {
...
const updateRestaurants = () => {
    ...
    const fetchCuisine = document.getElementById("cuisines-select").addEventListener("change", (e) => {
